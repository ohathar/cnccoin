...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cnccoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cnccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cnccoin transaction") + "\n" +
              "  cnccoin-tx [options] -create [commands]   " + _("Create hex-encoded cnccoin transaction") + "\n" +
              "\n";
