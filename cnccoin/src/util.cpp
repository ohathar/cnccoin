...
const char * const BITCOIN_CONF_FILENAME = "cnccoin.conf";
const char * const BITCOIN_PID_FILENAME = "cnccoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CNCcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/CNCcoin";
#else
    // Unix
    return pathRet / ".cnccoin";
#endif
#endif
}
